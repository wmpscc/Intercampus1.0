...
public class ExploreSubpage01 extends Fragment {
    private RecyclerView recyclerView;
    private MultiTypeAdapter adapter;
    private Items items;
    private View view;

    public ExploreSubpage01() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view=inflater.inflate(R.layout.fragment_explore_subpage01, container, false);
        recyclerView=view.findViewById(R.id.rvlist_e1);
